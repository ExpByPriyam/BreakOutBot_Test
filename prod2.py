    ...
    for i in range(0, len(df), chunk_size):
        ...
        for index, row in chunk.iterrows():
            ...
            if pd.notna(row['original_pl']):
                ...
                pl_occurrences_array.append(row['original_pl'])
            if row['breakout'] and original_ph_occurrences >= 2:
                ...
                print(f"original_ph_occurrences array: {ph_occurrences_array}")
            if row['breakdown'] and original_pl_occurrences >= 2:
                ...
                print(f"original_pl_occurrences array: {pl_occurrences_array}")
